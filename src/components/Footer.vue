...
<div class="p-4 bg-black sm:p-6 mt-10">
    <div class="md:flex md:justify-between pl-20">
        <div class="mb-6 md:mb-0 w-full">
            <div class="flex items-center cursor-pointer">
                <img src="./images/logo.png" class="" />
            </div>
            <div class="text-white mt-4">
              Lorem ipsum dolor sit amet consectetur adipisicing elit. Molestias perspiciatis praesentium, con
            </div>
        </div>
        <div class="flex justify-center items-center w-full gap-10">
            <div>
                <div class=" text-sm font-semibold text-white border-l-4 border-red-600 uppercase mb-3 pl-2">quick link</div>
                  <div class="items-center uppercase text-white justify-center" >
                    <div v-for="tab in tabs" :key="tab.id"  class="">
                        <router-link :to="{path: tab.to}" class="hover:text-[#ed3833]  hover:opacity-100 opacity-50">
                        {{ tab.title }}
                        </router-link>
                  </div>
                  </div>
        ...
        <div class="flex justify-center w-full">
            <div>
                <div class=" text-sm font-semibold text-white border-l-4 border-red-600 uppercase mb-3 pl-2">
                  Follow us
                </div>
                <div class="flex space-x-6 sm:justify-center mt-5">
                    <a href="#" class="text-gray-500 hover:text-red-600 border-b-4 border-transparent hover:border-red-600 ">
    ...
    <div class="flex items-center justify-center px-20">
        <span class="text-sm  sm:text-center text-gray-400">
            © 2023 
            <a href="https://ron.digital" class="hover:underline">
            Ron Digital
            </a>
            . All Rights Reserved.
        </span>
